    ...
    class Program
    {
        ...
        public void input()
        {
            while (true)
            {
                ...
                if ((n > 0) && (n <= 20))
                    ...
                    Console.WriteLine
                        ("\nArray should have minimum 1 and maximum 20 lements. \n");
            }
        ...
        public void BinarySearch()
        {
            ...
            do
            {
                ...
                Console.Write
                    ("\nEnter elements want you to be search : ");
                ...
                if (item == arr[mid])
                    Console.WriteLine("\n" + item.ToString() + "found at positian" + (mid + 1).ToString());
                else
        ...
        public void LinearSearch()
        {
            ...
            do
            {
                ...
                if (i == n)
                    Console.WriteLine("\n" + item.ToString() + " not found in the aray ");
                Console.WriteLine("\n Number of comparison: " + ctr);
                Console.Write("\nContinue search (y/n); ");
                ch = char.Parse((Console.ReadLine().ToUpper()));
            } while ((ch == 'y'));
